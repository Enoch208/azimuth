...
**[ Play it ↗ ](https://azimuth-inco.vercel.app)** · **[ Watch the demo ↗ ](#demo)** · **[ Onchain evidence ↗ ](evidence/deployment.md)** · **[ Run it locally ↗ ](#run-it-locally)**

Built for the **Inco Summer Game Jam**, on **Inco Lightning** over Base Sepolia.

<video id="demo" src="docs/azimuth-demo.mp4" width="720" controls playsinline>
  <a href="docs/azimuth-demo.mp4">Watch the demo</a>
</video>
